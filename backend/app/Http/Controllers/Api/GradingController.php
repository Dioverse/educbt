...
class GradingController extends Controller
{
    ...
    /**
     * Get answer details for grading
     */
    public function getAnswerForGrading(int $answerId): JsonResponse
    {
        try {
            $answer = $this->gradingService->getAnswerForGrading($answerId);
    ...
    public function getGradingStatistics(Request $request): JsonResponse
    {
        try {
            $examId = $request->input('exam_id');
            $stats = $this->gradingService->getStatistics($examId);

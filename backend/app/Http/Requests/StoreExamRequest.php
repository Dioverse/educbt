...
class StoreExamRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Result Display
            'result_display' => 'required|in:immediate,scheduled,manual',
            'result_publish_datetime' => 'nullable|date|required_if:result_display,scheduled',
    ...
    public function messages(): array
    {
        return [
            ...
            'duration_minutes.required' => 'Exam duration is required',
            ...
            'result_display.required' => 'Result display type is required',

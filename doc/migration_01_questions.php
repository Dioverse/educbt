...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('questions', function (Blueprint $table) {
            $table->id();
            $table->string('code')->unique()->nullable(); // Q-00001
            $table->enum('type', [
            ...
            $table->text('question_html')->nullable(); // Rich text version
            ...
            // For match/drag-drop
            $table->json('pairs_data')->nullable(); // Store pairs as JSON
            
            // Categorization
            $table->foreignId('subject_id')->nullable()->constrained('subjects')->nullOnDelete();
            $table->foreignId('topic_id')->nullable()->constrained('topics')->nullOnDelete();
            $table->enum('difficulty_level', ['easy', 'medium', 'hard', 'expert'])->default('medium');
            $table->json('tags')->nullable(); // ['algebra', 'equations', 'grade-10']
            ...
            $table->decimal('difficulty_index', 5, 4)->nullable(); // Calculated from attempts
            ...
            $table->boolean('is_verified')->default(false); // Moderation flag
            ...
            $table->index('type');
            $table->fullText(['question_text', 'explanation']);
        });
    }

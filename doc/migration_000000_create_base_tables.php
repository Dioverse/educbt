...
return new class extends Migration
{
     ...
     * Run the migrations.
     * 
     * This migration creates base tables that might not exist if you don't have
     * an existing school management system. These tables are required by CBT migrations.
     */
    public function up(): void
    {
        ...
        if (!Schema::hasTable('classes')) {
            Schema::create('classes', function (Blueprint $table) {
                $table->id();
                $table->string('name'); // Class A, Class B, etc.
        ...
        // Note: roles and permissions tables are handled by Spatie Permission package
        // Run: php artisan migrate after installing spatie/laravel-permission
    }
